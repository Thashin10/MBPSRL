...
Write-Host "============================================================"
Write-Host "PETS Baseline Experiments - CartPole & Pendulum"
Write-Host "============================================================"
Write-Host "Running 2 environments × 5 seeds = 10 total runs"
...
$experiments = @(
    @{Name="PETS CartPole"; Script="baselines/pets/run_pets_cartpole.py"; EnvPrefix="pets_cartpole"}
    @{Name="PETS Pendulum"; Script="baselines/pets/run_pets_pendulum.py"; EnvPrefix="pets_pendulum"}
)
...
for ($expIdx = 0; $expIdx -lt $experiments.Count; $expIdx++) {
    ...
    for ($seed = 0; $seed -lt $NumSeeds; $seed++) {
        ...
        Write-Host "------------------------------------------------------------"
        Write-Host "Running: python $($exp.Script) --seed $seed --num-episodes 15"
        Write-Host ""
        
        & $CondaExe run -n mbpsrl python $($exp.Script) --seed $seed --num-episodes 15
        ...
        # Verify output
        $file = "seeds_data\$($exp.EnvPrefix)_timestep_rewards_seed${seed}.txt"
...
Write-Host ""
Write-Host "============================================================"
Write-Host "ALL PETS EXPERIMENTS COMPLETE!"
Write-Host "============================================================"
...
Write-Host ""
Write-Host "============================================================"
Write-Host "Next: Generate comparison plots (PSRL vs PETS)"
Write-Host "============================================================"
